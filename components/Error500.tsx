    ...
    return (
        <div className="flex h-full items-center justify-center p-5 w-full flex-1">
            <div className="text-center">
                ...
                <Link href={'https://layerswap.io/help'} target="_blank" className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary-500 rounded-lg shrink-0 sm:w-auto hover:bg-primary-500/80">
                    Contact support
                </Link>
            </div>
        </div>
