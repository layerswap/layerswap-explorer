    ...
    return (
        <footer className="overflow-hidden py-6 md:grid grid-cols-3 w-full px-6 lg:px-8 mt-auto relative z-20">
            ...
            <div className="flex justify-center mt-3 md:mt-0 gap-6 order-2 place-self-center">
                <Link target="_blank" href="https://docs.layerswap.io/user-docs/more-information/privacy-policy/" className="text-xs leading-6 text-tertiary hover:text-opacity-70 duration-200 transition-all">
                    Privacy Policy
                </Link>
                <Link target="_blank" href="https://docs.layerswap.io/user-docs/more-information/terms-of-services/" className="text-xs leading-6 text-tertiary hover:text-opacity-70 duration-200 transition-all">
                    Terms of Services
                </Link>
            </div>
            <div className="mt-3 order-1 md:mt-0 place-self-start">
                <p className="text-center text-xs text-tertiary leading-6">
