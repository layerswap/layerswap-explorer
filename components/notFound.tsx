    ...
    return (
        <section className="fixed inset-0 flex items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center text-center p-4 relative z-20">
                ...
                <p className="text-base text-tertiary mt-2">Please make sure you entered a valid address/source Tx/destination TX.</p>
                <span className="text-base text-tertiary block">If the issue persists, you can contact our support.</span>
